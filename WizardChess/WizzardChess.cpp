...
void WizzardChess::initWindow(int width, int height)
{
    glfwInit();
...
void WizzardChess::createInstance() {
...
void WizzardChess::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
    createInfo = {};
...
void WizzardChess::setupDebugMessenger() {
...
void WizzardChess::createSurface() {
    if (glfwCreateWindowSurface(m_instance, m_window, nullptr, &m_surface) != VK_SUCCESS) {
        throw std::runtime_error("failed to create window surface!");
    }
}

void WizzardChess::pickPhysicalDevice() {
...
void WizzardChess::createLogicalDevice() {
...
void WizzardChess::createSwapChain() {
...
void WizzardChess::createImageViews() {
...
void WizzardChess::createCommandPool() {
...
VkImageView WizzardChess::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void WizzardChess::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(m_device, m_commandPool);
...
void WizzardChess::createCommandBuffers() {
...
VkShaderModule WizzardChess::createShaderModule(const std::vector<char>& code) {
...
VkSurfaceFormatKHR WizzardChess::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR WizzardChess::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D WizzardChess::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
SwapChainSupportDetails WizzardChess::querySwapChainSupport(VkPhysicalDevice device) {
...
bool WizzardChess::isDeviceSuitable(VkPhysicalDevice device) {
...
bool WizzardChess::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices WizzardChess::findQueueFamilies(VkPhysicalDevice device) {
...
std::vector<const char*> WizzardChess::getRequiredExtensions() {
...
bool WizzardChess::checkValidationLayerSupport() {
    uint32_t layerCount;
...
std::vector<char> WizzardChess::readFile(const std::string& filename)
{
...
VKAPI_ATTR VkBool32 VKAPI_CALL WizzardChess::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
